...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "femto-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/test_org888"
  #   chef.validation_client_name = "test_org888-validator"
  #   chef.validation_key_path = ".chef/test_org888-validator.pem"
  # end
end
